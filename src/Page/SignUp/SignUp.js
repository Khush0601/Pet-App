...
const navigate=useNavigate()
  ...
  return (
    <div className={style['signUp-container']} >
     ...
     <div className={style['input-container']}>
     <TextFieldPasswordIcon label={'Confirm password'} id={'confirmPassword'} value={registerUser.onfirmPassword} htmlFor={'onfirmPassword'} onChange={(e)=>onInputUpdate(e,'onfirmPassword')}/>
     </div>
     <div className={style['input-container']}>
